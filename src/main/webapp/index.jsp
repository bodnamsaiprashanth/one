...
<body>
	<h1 style="color: violet; font-size: 40px;" align="center">podamaa bhayatak antta anil anna aduguthunnadu</h1>
	...
	<h1 style="color: red; font-size: 40px;" align="center">WELCOME TO FRONTLINES MEDIA</h1>
        <h1 style="color: yellow; font-size: 40px;" align="center">gatham gatham</h1>
